        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambah" style="margin-bottom: 10px">TAMBAH PEMBELI</button>
                                                ...
                                                <form action="proses_edit.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama_pembeli" class="form-control" id="nama_pembeli" value="<?= $row['nama_pembeli'] ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label" for="jk">Jenis Kelamin</label>
                                                            <div class="form-check form-check">
                                                                <input class="form-check-input" type="radio" name="jk" id="jk" value="L" <?php if ($row['jk'] === 'L') echo 'checked'; ?>>
                                                                <label class="form-check-label" for="inlineRadio1">L</label>
                                                            </div>
                                                            <div class="form-check form-check">
                                                                <input class="form-check-input" type="radio" name="jk" id="jk" value="P" <?php if ($row['jk'] === 'P') echo 'checked'; ?>>
